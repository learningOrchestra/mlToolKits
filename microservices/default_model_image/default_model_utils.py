...
class Metadata:
    ...
    def create_file(self, model_name, description, tool, function,
                    function_parameters):
...
class UserRequest:
    ...
    def valid_function_validator(self, tool_name, function_name):
        try:
    ...
    def valid_function_parameters_validator(self, tool, function,
                                            function_parameters):
